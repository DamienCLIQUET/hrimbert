    ...
    <body>
        ...
        while ($datapoint = $retourpoints->fetch()){
            ...
            <div style='margin: 50px;'>
                ...
                <div style='border-top: solid 1px black; display: flex; justify-content: space-between;'>
                    <div style='width: 100%;'>
                    ...
                    <div style=''>
                        ...
                        ?>
                        <div id="chantier_details_plan_canvas" style="width: calc(<?php echo $larg * $haut; ?>px);
