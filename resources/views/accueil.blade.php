                ...
                @if($statut->visible == '1')
                    <div class="accueil_statut_chantiers">
                        @forelse($statut->chantiers as $chantier)
                            <div class="accueil_statut_chantiers_chantier">
                                ...
                                <div class="accueil_statut_chantiers_chantier_action">
                                    ...
                                    <a class="accueil_statut_chantiers_chantier_action_action">04/07/24 Système : Création du chantier</a>
                                    <a class="accueil_statut_chantiers_chantier_action_tarif">0€ TTC</a>
                                </div>
                            </div>
                        @empty
                        @endforelse
